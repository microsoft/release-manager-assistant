...
*/
resource releaseManagerProject 'Microsoft.CognitiveServices/accounts/projects@2025-04-01-preview' = {
  name: projectName
  parent: aiFoundry
  location: location
  tags: tags
...
output responseApiDeploymentName string = gpt4oDeployment.name
