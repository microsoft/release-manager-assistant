...
from common.contracts.configuration.agent_config import AzureOpenAIResponsesAgentConfig, AzureAIAgentConfig
...
class ResolvedOrchestratorConfig(BaseModel):
    """
    Represents a fully resolved orchestrator configuration, including all referenced configurations.
    ...
    def _get_agent_name(config: AgentConfig) -> Optional[str]:
        """Gets agent name from configuration."""
    ...
    def get_agent_config(self, agent_name: str) -> Optional[Union[AzureOpenAIResponsesAgentConfig, AzureAIAgentConfig]]:
        """
