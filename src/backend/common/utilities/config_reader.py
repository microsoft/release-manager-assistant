...
class Config(Enum):
    ...
    SESSION_MAX_RESPONSE_TIMEOUT_IN_SECONDS = "SESSION-MAX-RESPONSE-TIMEOUT-IN-SECONDS"
    ...
    # JIRA Settings
    USE_JIRA_MCP_SERVER = "USE-JIRA-MCP-SERVER"
    ...
    # DEPRECATED: DevOps Database Settings - Use AZURE_DEVOPS_ORG_NAME instead for MCP-based integration
    ...
    # Azure DevOps MCP Settings (Preferred)
    USE_AZURE_DEVOPS_MCP_SERVER = "USE-AZURE-DEVOPS-MCP-SERVER"
    AZURE_DEVOPS_MCP_SERVER_ENDPOINT = "AZURE-DEVOPS-MCP-SERVER-ENDPOINT"
    AZURE_DEVOPS_ORG_NAME = "AZURE-DEVOPS-ORG-NAME"
